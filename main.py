...
QURAN_REASONS = {
"سورة الفاتحة مكية، سميت بأم القرآن، نزلت لتعليم المسلمين حمد الله والاستعانة به. هي ركن الصلاة.",
"سورة البقرة مدنية، أول سورة نزلت بالمدينة، تعالج أحكام التشريع والعبادات وتقص قصص بني إسرائيل.",
"آل عمران مدنية، نزلت بعد غزوة بدر، تثبت عقيدة التوحيد وترد على النصارى.",
"يس مكية، قلب القرآن، نزلت لتثبيت النبي وتأكيد الرسالة والبعث.",
"الكهف مكية، نزلت ردا على أسئلة المشركين عن أصحاب الكهف وذي القرنين.",
"الرحمن مدنية، نزلت لتبيان نعم الله وتذكير الجن والإنس.",
"الملك مكية، نزلت لتأكيد عظمة الله وقدرته والترغيب في التفكر.",
"الإخلاص مكية، تعدل ثلث القرآن، نزلت ردا على من سأل عن صفة الله.",
}
QURAN_TAFSIR = {
"تفسير الفاتحة: حمد لله وثناء عليه، إقرار بربوبيته، طلب الهداية للصراط المستقيم. ابن كثير",
"تفسير البقرة: أحكام الصلاة والصيام والحج، قصص الأنبياء، آيات الربا والدين. القرطبي",
"يس: تأكيد نبوة محمد، قصص القرون، إحياء الموتى دليل البعث. الطبري",
"الكهف: عصمة من الفتن الأربع (الدين، المال، العلم، السلطة). السعدي",
}

# ترجمات مختارة (EN/FR) - سورة الفاتحة والاخلاص كمثال، الباقي يجلب من API
QURAN_TRANSLATIONS = {
{
{"ar": "بسم الله الرحمن الرحيم", "en": "In the name of Allah, the Entirely Merciful, the Especially Merciful.", "fr": "Au nom d'Allah, le Tout Miséricordieux, le Très Miséricordieux.", "ber": "Tasuqilt s tmazight."},
{"ar": "الحمد لله رب العالمين", "en": "All praise is due to Allah, Lord of the worlds.", "fr": "Louange à Allah, Seigneur de l'univers.", "ber": "Tasuqilt s tmazight."},
{"ar": "الرحمن الرحيم", "en": "The Entirely Merciful, the Especially Merciful.", "fr": "Le Tout Miséricordieux, le Très Miséricordieux.", "ber": "Tasuqilt s tmazight."},
{"ar": "مالك يوم الدين", "en": "Sovereign of the Day of Recompense.", "fr": "Maître du Jour de la rétribution.", "ber": "Tasuqilt s tmazight."},
{"ar": "إياك نعبد وإياك نستعين", "en": "It is You we worship and You we ask for help.", "fr": "C'est Toi seul que nous adorons, et c'est Toi seul dont nous implorons secours.", "ber": "Tasuqilt s tmazight."},
{"ar": "اهدنا الصراط المستقيم", "en": "Guide us to the straight path.", "fr": "Guide-nous dans le droit chemin.", "ber": "Tasuqilt s tmazight."},
{"ar": "صراط الذين أنعمت عليهم غير المغضوب عليهم ولا الضالين", "en": "The path of those upon whom You have bestowed favor, not of those who have evoked Your anger or of those who are astray.", "fr": "Le chemin de ceux que Tu as comblés de faveurs, non pas de ceux qui ont encouru Ta colère, ni des égarés.", "ber": "Tasuqilt s tmazight."},
    },
{
{"ar": "قل هو الله أحد", "en": "Say, He is Allah, [who is] One.", "fr": "Dis: Il est Allah, Unique.", "ber": "Tasuqilt s tmazight."},
{"ar": "الله الصمد", "en": "Allah, the Eternal Refuge.", "fr": "Allah, Le Seul à être imploré pour ce que nous désirons.", "ber": "Tasuqilt s tmazight."},
{"ar": "لم يلد ولم يولد", "en": "He neither begets nor is born.", "fr": "Il n'a jamais engendré, n'a pas été engendré non plus.", "ber": "Tasuqilt s tmazight."},
{"ar": "ولم يكن له كفوا أحد", "en": "Nor is there to Him any equivalent.", "fr": "Et nul n'est égal à Lui.", "ber": "Tasuqilt s tmazight."},
    }
}
